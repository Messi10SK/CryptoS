...
const Featured = () => {
  return (
    <section className='w-full py-32 bg-gray-900 text-white clip-path'>
      <div className='container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-4'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          <Link to='/dashboard'>
            <button className='bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded'>See More Coins</button>
          </Link>
        </div>
        {/* Right */}
        <div className='relative'>
          {/* Featured Image */}
          <img
            src='https://t3.ftcdn.net/jpg/04/68/35/26/360_F_468352674_XFsZXwhCBrX85gtKYJfX4ZLhC0NrIXA9.jpg'
            alt='Featured'
